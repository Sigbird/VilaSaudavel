...
namespace YupiStudios.API.Transform 
{
	...
	/*
	 * Transforma o objeto, para um tamanho relativo a tela (Screen)
	 * 
	 * O Objeto deve inicialmente estar no tamanho 1x1 em Unity World
	 */
	public class RelativeToScreen : MonoBehaviour {
		...
		////////////////////////////////////////////////////////////////
		/// Se verdadeira a transformacao sera executada
	    /// a cada update do objeto (normalmente usado para editcao)
		////////////////////////////////////////////////////////////////
		...
		private void UpdateObject() {
			...
			if (useSize)
			{
				...
				/* Aspect e preservado pela menor alteracao */
				if (saveAspectRatio)
				{
					if (diffX < diffY)
						diffY = diffX;
